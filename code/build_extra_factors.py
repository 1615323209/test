...
INPUT = Path("/home/ubuntu/quant_data/factor_daily.parquet")  # 主库（含原始列）
INPUT_INCR = Path("/home/ubuntu/quant_data/factor_daily_incr.parquet")  # 增量（多文件 scan）
INPUT_COLS = ['日期', '收盘', '成交量', '成交额', '股票代码']
OUTPUT = Path("/home/ubuntu/quant_data/factor_extra_daily.parquet")
TMPDIR = Path("/home/ubuntu/quant_data/extra_tmp")
CHUNK = 500

from extra_factors import calc_extra_factors, EXTRA_FACTOR_COLS
