...
FACTOR = Path("/home/ubuntu/quant_data/factor_daily.parquet")
NORTH = Path("/home/ubuntu/quant_data/north_fund_flow.parquet")
OUT = Path("/home/ubuntu/quant_data/market_daily.parquet")
